...
when weighted signal score >= 10/17.

Signals:
  Bollinger Band recently tagged (4H)  — weight 4
  OBV Divergence 1H                    — weight 4
  OBV Divergence 4H                    — weight 4
  RSI 4H overbought/diverge            — weight 3
  Funding Rate elevated                — weight 2

Hard gate: pullback filter (15% min swing, 5-20% retrace window)
Conditional: RSI 1H check (informational only) when funding is negative
             AND RSI 4H fired
"""
